...
# from xgboost.config_context import XGBRegressor
...
# # data.to_csv(r'600000.csv')
#
#
#
# #将日期设置为index，并且转化为datatime格式
# data=pd.read_csv(r'600000.csv',  index_col='date',  parse_dates=['date'])
#
# #数据特征处理
# base1=data['close']
# base2=data.shift(1)
...
# y_pred=(model.predict(x_test_std)*0.7+model.predict(x_test_std)*0.3)
...
# data = ts.get_k_data('000906', start='2018-11-02', end='2021-07-02')
# # 将数据保存到指定路径
